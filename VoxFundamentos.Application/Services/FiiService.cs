...
public class FiiService : IFiiService
{
    ...
    )
    {
        ...
        var carteira = await ObterCarteiraPorPerfisAsync(req, qtdCotas: 1, ct);
        ...
        PerfilAporteDto MontarPerfil(string perfil, decimal percentual)
        {
            ...
            {
                var cotacao = f.PrecoParaComprar;
    ...
    CancellationToken ct)
    {
        ...
        var fiis = (await ObterFiisFiltradosAsync(top: top, qtdCotas: 1, ct)).ToList();
