...
{
    Task<IEnumerable<FiiDto>> ObterFiisAsync(int qtdCotas, CancellationToken ct);
    Task<FiiDto?> ObterPorPapelAsync(string papel, int qtdCotas, CancellationToken ct);
    Task<IEnumerable<FiiDto>> ObterFiisFiltradosAsync(int qtdCotas, CancellationToken ct);
